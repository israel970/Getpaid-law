  ...
  return (
    <>
      ...
      <section className="py-16 px-4 bg-dark">
        <div className="max-w-[900px] mx-auto">
          ...
          <ScrollReveal delay={200}>
            <p className="text-gray-light text-lg mb-6 leading-relaxed">
              Too many personal injury firms prioritize <span className="text-gold font-semibold">volume over quality</span>. They settle cases quickly for less than they&apos;re worth, move on to the next client, and leave injured victims without the compensation they deserve.
            </p>
          </ScrollReveal>
      ...
      <section className="py-16 px-4 bg-dark">
        <div className="max-w-[900px] mx-auto">
          <ScrollReveal>
            <h2 className="text-2xl md:text-3xl font-black mb-6 text-center">Our Promise to You</h2>
          </ScrollReveal>
          <div className="grid md:grid-cols-3 gap-6">
            <ScrollReveal delay={100}>
              <TiltCard>
                <div className="glass rounded-xl p-6 h-full">
                  <h3 className="text-xl font-bold mb-3 text-gold">Free Consultation</h3>
            ...
            <ScrollReveal delay={200}>
              <TiltCard>
                <div className="glass rounded-xl p-6 h-full">
                  <h3 className="text-xl font-bold mb-3 text-gold">No Fee Unless You Win</h3>
            ...
            <ScrollReveal delay={300}>
              <TiltCard>
                <div className="glass rounded-xl p-6 h-full">
                  <h3 className="text-xl font-bold mb-3 text-gold">Vetted Attorneys Only</h3>
