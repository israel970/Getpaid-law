      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-[800px] mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-6">
            Nuestra <span className="text-accent">Misión</span>
          </h1>
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-black border border-gray rounded-xl p-6">
              <h3 className="text-xl font-bold mb-3 text-accent">Consulta Gratis</h3>
              <p className="text-gray-light">Nunca pagará por una revisión inicial del caso. Evaluamos su situación sin costo.</p>
            </div>
            <div className="bg-black border border-gray rounded-xl p-6">
              <h3 className="text-xl font-bold mb-3 text-accent">Sin Honorarios Si No Gana</h3>
            ...
            <div className="bg-black border border-gray rounded-xl p-6">
              <h3 className="text-xl font-bold mb-3 text-accent">Solo Abogados Verificados</h3>
