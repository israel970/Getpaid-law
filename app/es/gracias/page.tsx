  ...
  return (
    <section className="py-20 md:py-32 px-4">
      <div className="max-w-[600px] mx-auto text-center">
        {/* Success Icon */}
        <div className="w-20 h-20 bg-accent text-black rounded-full flex items-center justify-center mx-auto mb-8">
        ...
        <div className="bg-dark border border-gray rounded-2xl p-8 mb-8 text-left">
          ...
          <ol className="space-y-4">
            <li className="flex gap-4">
              <span className="flex-shrink-0 w-8 h-8 bg-accent text-black rounded-full flex items-center justify-center font-bold">1</span>
              <div>
            ...
            <li className="flex gap-4">
              <span className="flex-shrink-0 w-8 h-8 bg-accent text-black rounded-full flex items-center justify-center font-bold">2</span>
              <div>
            ...
            <li className="flex gap-4">
              <span className="flex-shrink-0 w-8 h-8 bg-accent text-black rounded-full flex items-center justify-center font-bold">3</span>
              <div>
