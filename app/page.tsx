...
// Award badges
const awardBadges = [
  { name: 'Million Dollar Advocates Forum', subtitle: 'Member' },
  { name: 'Super Lawyers', subtitle: 'Rising Stars' },
  { name: 'Top 100', subtitle: 'Trial Lawyers' },
  { name: 'AV Rated', subtitle: 'Martindale-Hubbell' },
]
        ...
        <div className="relative">
          ...
          <div className="flex animate-scroll" style={{ animationDuration: '25s' }}>
            {[...awardBadges, ...awardBadges, ...awardBadges, ...awardBadges].map((badge, index) => (
              ...
              >
                <div className="flex flex-col items-center opacity-60 hover:opacity-100 transition-all duration-300 hover:drop-shadow-[0_0_15px_rgba(255,184,0,0.4)] group cursor-pointer">
                  {/* Badge Icon */}
                  <div className="w-16 h-16 md:w-20 md:h-20 rounded-full border-2 border-gold/50 group-hover:border-gold flex items-center justify-center mb-2 transition-colors">
                    <svg className="w-8 h-8 md:w-10 md:h-10 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                    </svg>
                  </div>
                  <span className="text-white text-xs md:text-sm font-semibold text-center leading-tight">{badge.name}</span>
